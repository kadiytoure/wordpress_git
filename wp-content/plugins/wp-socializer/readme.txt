...
* Insert **42+ social share icons** which are highly scalable.
...
* Insert **42+ follow me icons** in floating bar and widgets.
* Insert **text sharebar** with 11 social network support.
* Add **mobile sharebar** which supports icons of 42+ networks.
...
Add to favorites, Behance, Bitbucket, Blogger, CodePen, Comments, Delicious, DeviantArt, Digg, Dribbble, Email, Facebook, Facebook messenger, Flickr, Github, Google, Google Plus, Hacker News, Instagram, LinkedIn, Medium, PayPal, PDF, Pinterest, Pocket, Print, Reddit, RSS, Short link, Snapchat, Soundcloud, StackOverflow, StumbleUpon, Quora, Telegram, Tumblr, Twitter, Vimeo, VKontakte, wechat, WhatsApp, Xing, Yahoo! Mail, Youtube
...
* StumbleUpon, Reddit, LinkedIn
* Sharethis, Pinterest & Pocket
...
8. Social media share widgets.
9. Selected text sharebar with green theme selected.
10. Conditional display UI.
11. Administration page 1
12. Administration page 2
13. Setup wizard, page 1
14. Setup wizard, page 2
